    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li><i class="icon-chevron-right"></i></li>
                <li><div class="text-tiny">Add Weight</div></li>
            </ul>
        </div>
        <form class="tf-section-2 form-add-product" method="POST" action="{{ route('admin.weight.save') }}">
            @csrf
            <div class="wg-box">
                <fieldset class="name">
                ...
                <div class="cols gap10">
                    <button class="tf-button w-full" type="submit">Add Weight</button>
                </div>
            </div>
        </form>
    </div>
